...
import { howWellCards } from "./howWellDoYouKnowMe";
...
export const DECKS_BY_ID: Record<string, Card[]> = {
  ...
  'hwdykm-mild-v1': howWellCards
  // 'hwdykm-nsfw-v1': [...], TODO: No deck data for this one yet
}
...
export const DEFAULT_DECK_BY_GAME: Record<string, string> = {
  ...
  'how-well-do-you-know-me': 'hwdykm-mild-v1',
}
