...
const Home = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-light dark:bg-dark">
      <View className="flex-1 border-white my-16 mx-8 rounded-lg shadow-sm shadow-dark dark:shadow-light"> 
      </View> 
        <LottieView source={require('@/assets/snake.json')} autoPlay loop />
      <Pressable
